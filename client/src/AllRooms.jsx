      ...
      <div>
        <div className="flex flex-col items-start text-left">
          ...
          <p className="text-sm md:text-base text-gray-500/90 mt-2 max-w-174">
            ...
            enhance your stay and create unforgottable memories.
          </p>
        </div>
        {filteredRooms.map((room) => (
          <div
            key={room._id}
            className="flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:pt-30 last:border-0"
          >
            <img
              onClick={() => {
